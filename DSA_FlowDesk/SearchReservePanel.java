...
public class SearchReservePanel extends JPanel {
    ...
    private void initializeSeatData() {
        ...
        allSeats.add(new Seat("A-201", "Main Building", "10:00 - 12:00", 10, 4, "PC • Airconditioned"));
        allSeats.add(new Seat("A-102", "Main Building", "14:00 - 16:00", 8, 2, "Silent Zone"));
        allSeats.add(new Seat("B-101", "Annex", "13:00 - 15:00", 6, 3, "Near Window"));
        allSeats.add(new Seat("B-202", "Annex", "09:00 - 11:00", 12, 7, "Group Study"));
        allSeats.add(new Seat("C-301", "Library Wing", "15:00 - 17:00", 20, 10, "PC • Projector"));
        allSeats.add(new Seat("C-105", "Library Wing", "08:00 - 10:00", 5, 1, "Silent Zone • Individual"));
    }
    ...
    private JPanel createSeatCard(Seat seat) {
        ...
        reserveButton.setBackground(seat.getAvailableSeats() > 0 ? ACCENT_BLUE : new Color(150, 150, 150));
        reserveButton.setBorderPainted(false);
        reserveButton.setFocusPainted(false);
        reserveButton.setOpaque(true);
        reserveButton.setContentAreaFilled(true);
        reserveButton.setCursor(new Cursor(seat.getAvailableSeats() > 0 ? Cursor.HAND_CURSOR : Cursor.DEFAULT_CURSOR));
        reserveButton.setPreferredSize(new Dimension(120, 40));
        reserveButton.setEnabled(seat.getAvailableSeats() > 0);
        ...
        reserveButton.addActionListener(e -> {
            if (seat.getAvailableSeats() > 0) {
                if (joinQueueCallback != null) {
                    ...
                    String message = "You selected room " + seat.getRoomCode() +
